...
int main(void)
{
  ...
  if(MOTOR_CAN_TURN){
	  ...
	  __HAL_TIM_SET_COMPARE(&htim2, TIM_CHANNEL_1, 1680); // Gestion du PWM avec le Thrust
	  __HAL_TIM_SET_COMPARE(&htim2, TIM_CHANNEL_2, 1680); // Gestion du PWM avec le Thrust
	  __HAL_TIM_SET_COMPARE(&htim2, TIM_CHANNEL_3, 1680); // Gestion du PWM avec le Thrust
	  __HAL_TIM_SET_COMPARE(&htim2, TIM_CHANNEL_4, 1680); // Gestion du PWM avec le Thrust
  }
  ...
  hc12_init(&HC12);
  HC12.Current_Drone_Mode = Mode_Initialisation;
